...
public class HuaweiP10 extends Huawei {
    private final double batteryLife = 32;
    private double tempBatteryLife = batteryLife;
    private final String imei = "25478965412367";
    private List<Contact> contactListP10 = new ArrayList<>();
    private List<Message> messageListP10 = new ArrayList<>();
    private List<Call> callListP10 = new ArrayList<>();

    public HuaweiP10() {
        setColor("Sapphire Blue");
        setMaterial("Metal");
    }

    @Override
    public void addContact(String id, String phoneNumber, String firstName, String lastName) {
        contactListP10.add(new Contact(id, phoneNumber, firstName, lastName));
    }

    @Override
    public void listContacts() {
        System.out.println("Your contacts are: ");
        for (Contact c : contactListP10) {
    ...
    public void sendMessage(String phoneNumber, String messageContent) {
        if (tempBatteryLife >= 1) {
            ...
            messageListP10.add(new Message(phoneNumber, messageContent));
        } else {
    ...
    public Message listMessages(String phoneNumber) {
        ...
        Message result = null;
        for (Message sms : messageListP10) {
    ...
    public void call(String phoneNumber) {
        if (tempBatteryLife >= 2) {
            tempBatteryLife -= 2;
            callListP10.add(new Call(phoneNumber));
        } else {
